...
public partial class Pages_Representante_GerenciarMissoes : System.Web.UI.Page
{
    ...
    public void carregarListaParticipantes()
    {
        ...
        {
            DataSet listaDeUsuarios = MissaoBD.procurarUsuariosEmpresaRepresentante(usuarioLogado.Emp_id, usuarioLogado.Usu_id);
